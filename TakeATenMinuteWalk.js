...
//always walk only a single block in a direction and you know it takes you one minute to 
//traverse one city block, so create a function that will return true if the walk the app 
...
function isValidWalk(walk) {
  ...
  return starting[0] == 0 && starting[1] == 0 ? true : false;
};
