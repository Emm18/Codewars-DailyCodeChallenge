...
//Write a function mineLocation/MineLocation that accepts a 2D array, and returns the 
...
//location (both should be 0 based). All 2D arrays passed into your function will be 
//square (NxN), and there will only be one mine in the array.
