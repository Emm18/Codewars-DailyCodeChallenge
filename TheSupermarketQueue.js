...
//P.S. The situation in this kata can be likened to the more-computer-science-related idea of a thread pool, with relation to 
//running multiple processes at the same time: https://en.wikipedia.org/wiki/Thread_pool
...
function queueTime(customers, n) {
  ...
  for(let i = 0; i <= tills.length - 1; i++){
    if(tills[i] == 'empty'){
      tills[i] = customers.splice(0,1)[0];
    }
  }
  ...
  return timer + tills.sort((a, b) => b - a)[0]
}
