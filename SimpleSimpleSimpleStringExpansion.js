...
//The numeric values represent the occurrence of each letter preceding that numeric value. There should 
//be no numeric characters in the final string. Empty strings should return an empty string.
...
function generateStr(count,str){
  let result = '';
