...
// [North, South, South, East, West, North, West]
// You can immediatly see that going "NORTH" and immediately "SOUTH" is not reasonable, better stay to the same place! So the 
...
function checkIfOpposite(s1,s2){
  if((s1 == "NORTH" && s2 == "SOUTH") || (s1 == "SOUTH" && s2 == "NORTH")){
    return true;
  }
  
  if((s1 == "EAST" && s2 == "WEST") || (s1 == "WEST" && s2 == "EAST")){
    return true;
  }
